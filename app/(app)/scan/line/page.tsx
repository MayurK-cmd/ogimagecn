...
import { FAQS, SECTIONS } from "@/content/scan/line";
...
export const metadata: Metadata = createPageMetadata({
  description:
    "Preview how your Open Graph image, title, and description appear in a LINE chat bubble. Scan a URL and check its metadata before you share it.",
  path: ROUTES.SCAN_LINE,
  title: "LINE Open Graph Preview",
});
  ...
  <PageTransition>
    <section className="container-wrapper relative">
      <div className="container flex flex-col gap-12 py-16 md:py-20 lg:py-24">
        <PageHero
          description="Paste a URL and see the link preview LINE will build from it."
          title="LINE Open Graph Preview"
        />

        <OgTester platform="line" />
        ...
        <section className="mx-auto flex w-full max-w-2xl flex-col gap-10">
          ...
          <BreadcrumbJsonLd items={scanBreadcrumbs("line")} />
        </section>
      </div>
    </section>
  </PageTransition>
