...
import { FAQS, SECTIONS } from "@/content/scan/snapchat";
  ...
  <PageTransition>
    <section className="container-wrapper relative">
      <div className="container flex flex-col gap-12 py-16 md:py-20 lg:py-24">
        <PageHero
          description="Paste a URL and see the card Snapchat will build from it in chat."
          title="Snapchat Open Graph Preview"
        />

        <OgTester platform="snapchat" />
        ...
        <section className="mx-auto flex w-full max-w-2xl flex-col gap-10">
          ...
          <nav className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              {otherScanPages("snapchat").map((page) => (
                <Link
          ...
          <BreadcrumbJsonLd items={scanBreadcrumbs("snapchat")} />
        </section>
      </div>
    </section>
  </PageTransition>
