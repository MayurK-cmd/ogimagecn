...
import { FAQS, SECTIONS } from "@/content/scan/threads";
...
export const metadata: Metadata = createPageMetadata({
  ...
  title: "Threads Open Graph Preview",
});

const ThreadsScanPage = () => (
  <PageTransition>
    <section className="container-wrapper relative">
      <div className="container flex flex-col gap-12 py-16 md:py-20 lg:py-24">
        <PageHero
          description="Paste a URL and see the bookmark Threads will build from it."
          title="Threads Open Graph Preview"
        />

        <OgTester platform="threads" />
        ...
        <section className="mx-auto flex w-full max-w-2xl flex-col gap-10">
          ...
          <nav className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              {otherScanPages("threads").map((page) => (
                <Link
          ...
          <BreadcrumbJsonLd items={scanBreadcrumbs("threads")} />
        </section>
      </div>
    </section>
  </PageTransition>
...
export default ThreadsScanPage;
