...
import { FAQS, SECTIONS } from "@/content/scan/tiktok";
...
export const metadata: Metadata = createPageMetadata({
  description:
    "Preview how your Open Graph image and title appear in a TikTok link card. Scan a URL and check its metadata before you share it.",
  path: ROUTES.SCAN_TIKTOK,
  title: "TikTok Open Graph Preview",
});

const TikTokScanPage = () => (
  <PageTransition>
    <section className="container-wrapper relative">
      <div className="container flex flex-col gap-12 py-16 md:py-20 lg:py-24">
        <PageHero
          description="Paste a URL and see the link preview TikTok will build from it."
          title="TikTok Open Graph Preview"
        />

        <OgTester platform="tiktok" />
        ...
        <section className="mx-auto flex w-full max-w-2xl flex-col gap-10">
          ...
          <nav className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              {otherScanPages("tiktok").map((page) => (
                <Link
          ...
          <BreadcrumbJsonLd items={scanBreadcrumbs("tiktok")} />
        </section>
      </div>
    </section>
  </PageTransition>
